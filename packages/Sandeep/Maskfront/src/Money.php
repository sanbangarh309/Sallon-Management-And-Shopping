...
class Money implements Arrayable, Jsonable, JsonSerializable, Renderable
{
     ...
     *
     * @param mixed                     $amount
     * @param \Sandeep\Money\Currency $currency
     * @param bool                      $convert
     *
     ...
     * assertSameCurrency.
     *
     * @param \Sandeep\Money\Money $other
     *
     ...
     * add.
     *
     * @param \Sandeep\Money\Money $addend
     *
     * @throws \InvalidArgumentException
     *
     * @return \Sandeep\Money\Money
     ...
     * subtract.
     *
     * @param \Sandeep\Money\Money $subtrahend
     *
     * @throws \InvalidArgumentException
     *
     * @return \Sandeep\Money\Money
